...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="map-legend">
      <span><span class="dot" style="background:#e74c3c;"></span> Probable Origin</span>
      <span><span class="dot" style="background:#f1c40f;"></span> Intermediate Relay</span>
      <span><span class="dot" style="background:#2ecc71;"></span> Final Visible Mail Server</span>
    </div>
